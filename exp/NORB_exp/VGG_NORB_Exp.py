...
def get_parser():
    ...
    parser.add_argument('--lr', default=0.0008, type=int)
    parser.add_argument('--weight_decay', default=4e-4, type=int)
    parser.add_argument('--dropout_rate', default=0.5, type=int)
    parser.add_argument('--dropconnect_rate', default=0.5, type=int)
    parser.add_argument('--gd_init_droprate', default=0.3, type=int)
    parser.add_argument('--gd_droprate', default=0.5, type=int)
    parser.add_argument('--w_init_droprate', default=0.3, type=int)
    parser.add_argument('--w_droprate', default=0.5, type=int)
